...
pub fn build(b: *std.build.Builder) !void {
    ...
    _ = make.exe("main", "examples/main/main.cpp", &.{ ggml, ggml_alloc, ggml_backend, ggml_quants, llama, unicode, common, buildinfo, sampling, console, grammar_parser, clip, llava });
